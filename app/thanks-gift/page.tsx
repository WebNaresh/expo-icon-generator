...
import { Gift, Heart, Coffee, Sparkles, ArrowLeft, ExternalLink } from "lucide-react";
import { Button } from "@/components/ui/button";

export const metadata: Metadata = {
  title: "Support Our Work | Expo Icon Generator",
  description: "Support the development of Expo Icon Generator and help us keep this tool free for everyone. Your contribution makes a difference!",
  openGraph: {
    title: "Support Our Work | Expo Icon Generator",
    description: "Support the development of Expo Icon Generator and help us keep this tool free for everyone.",
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
              Help us keep <span className="font-semibold text-blue-600">Expo Icon Generator</span> free 
              and continuously evolving for the developer community worldwide.
            </p>
          </div>
          ...
          <div className="bg-white rounded-3xl shadow-2xl p-10 mb-10 border border-gray-100">
            <div className="text-center mb-8">
              <div className="flex items-center justify-center gap-3 mb-4">
                ...
                <h2 className="text-3xl font-bold text-gray-900">Buy Us a Coffee</h2>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-10">
            ...
            <div className="text-center bg-white/80 backdrop-blur-sm rounded-2xl p-8 shadow-lg border border-gray-100">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Active Development</h3>
              <p className="text-gray-600">
          ...
          <div className="bg-gradient-to-r from-amber-50 to-orange-50 border-2 border-amber-200 rounded-2xl p-8 text-center">
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              <h3 className="text-2xl font-semibold text-amber-800">Thank You!</h3>
              <Heart className="w-6 h-6 text-red-500" />
            </div>
            <p className="text-lg text-amber-700 font-medium">
              Every contribution, big or small, helps us maintain and improve this tool. 
