...
export default function StructuredData() {
  const structuredData = {
    ...
    "description": "Free Expo Assets Generator and Icon Generator for React Native apps. Generate iOS, Android, and web icons from one image. Create adaptive icons, app store icons, and all expo icon sizes automatically.",
  ...
  const organizationData = {
    ...
    "description": "The ultimate expo icon generator and expo assets generator for React Native developers.",
    "sameAs": [
