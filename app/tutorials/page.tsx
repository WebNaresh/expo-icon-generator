    ...
    <div className="min-h-screen bg-linear-to-br from-purple-50 to-pink-50">
      <div className="container mx-auto px-4 py-12">
        ...
        <section className="mb-16">
          <h2 className="mb-8 text-3xl font-bold text-gray-900">Featured Tutorials</h2>
          <div className="grid gap-8 lg:grid-cols-3">
            {featuredTutorials.map((tutorial) => (
              <article key={tutorial.slug} className="overflow-hidden rounded-xl bg-white shadow-lg transition-shadow hover:shadow-xl">
                <div className="p-6">
                  ...
                  <div className="mb-4 flex flex-wrap gap-2">
                    {tutorial.topics.slice(0, 3).map((topic) => (
                      <span key={topic} className="rounded bg-purple-50 px-2 py-1 text-xs text-purple-600">
                        {topic}
                      </span>
                    ))}
                  </div>
        ...
        <section className="mb-12">
          <div className="flex flex-col gap-6 lg:flex-row">
            ...
            <div>
              <h3 className="mb-3 text-lg font-semibold text-gray-900">Difficulty</h3>
              <div className="flex flex-wrap gap-2">
        ...
        {/* All Tutorials */}
        <section>
          <h2 className="mb-8 text-3xl font-bold text-gray-900">All Tutorials</h2>
          <div className="grid gap-6 md:grid-cols-2">
            {allTutorials.map((tutorial) => (
              <article key={tutorial.slug} className="rounded-lg bg-white p-6 shadow-md transition-shadow hover:shadow-lg">
                ...
                <div className="flex items-center justify-between">
                  <div className="flex flex-wrap gap-1">
                    {tutorial.topics.slice(0, 2).map((topic) => (
                      <span key={topic} className="rounded bg-gray-100 px-2 py-1 text-xs text-gray-600">
                        {topic}
                      </span>
                    ))}
                  </div>
