    ...
    <div className="min-h-screen bg-linear-to-br from-green-50 to-emerald-50">
      <div className="container mx-auto px-4 py-12">
          ...
          <div className="space-y-8 rounded-xl bg-white p-8 shadow-lg">
            ...
            <section>
              ...
              <div className="space-y-4">
                <div className="rounded-lg bg-blue-50 p-4">
                  <h3 className="mb-2 text-lg font-semibold text-gray-900">Content Ownership</h3>
                  <p className="text-gray-700">
                ...
                <div className="rounded-lg bg-blue-50 p-4">
                  <h3 className="mb-2 text-lg font-semibold text-gray-900">Prohibited Content</h3>
                  <p className="mb-2 text-gray-700">You agree not to upload content that:</p>
                ...
                <div className="rounded-lg bg-blue-50 p-4">
                  <h3 className="mb-2 text-lg font-semibold text-gray-900">Acceptable Use</h3>
                  <p className="text-gray-700">
            ...
            <section>
              ...
              <div className="grid gap-6 md:grid-cols-2">
                <div className="rounded-lg bg-purple-50 p-4">
                  <h3 className="mb-2 text-lg font-semibold text-gray-900">Your Content</h3>
                  <p className="text-gray-700">
                ...
                <div className="rounded-lg bg-purple-50 p-4">
                  <h3 className="mb-2 text-lg font-semibold text-gray-900">Our Service</h3>
                  <p className="text-gray-700">
            ...
            <section>
              ...
              <div className="mb-4 border-l-4 border-yellow-400 bg-yellow-50 p-4">
                <h3 className="mb-2 text-lg font-semibold text-gray-900">Service Availability</h3>
                <p className="text-gray-700">
              ...
              <div className="mb-4 border-l-4 border-yellow-400 bg-yellow-50 p-4">
                <h3 className="mb-2 text-lg font-semibold text-gray-900">No Warranties</h3>
                <p className="text-gray-700">
              ...
              <div className="border-l-4 border-yellow-400 bg-yellow-50 p-4">
                <h3 className="mb-2 text-lg font-semibold text-gray-900">Limitation of Liability</h3>
                <p className="text-gray-700">
            ...
            {/* Privacy and Data */}
            <section>
              <h2 className="mb-4 text-2xl font-bold text-gray-900">Privacy and Data Handling</h2>
              
              <p className="mb-4 text-gray-700">
                Your privacy is important to us. Our data handling practices are described in detail in our <Link href="/privacy" className="font-medium text-blue-600 hover:text-blue-700">Privacy Policy</Link>.
              </p>
              
              <div className="rounded-lg bg-gray-50 p-4">
                <h3 className="mb-2 text-lg font-semibold text-gray-900">Key Points:</h3>
        ...
        <div className="mt-12 space-x-4 text-center">
          ...
          <Link 
            href="/"
            className="inline-flex items-center gap-2 rounded-lg bg-gray-600 px-6 py-3 font-medium text-white transition-colors hover:bg-gray-700"
          >
            ← Back to Home
          </Link>
        </div>
